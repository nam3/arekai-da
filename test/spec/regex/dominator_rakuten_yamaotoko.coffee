...
describe 'dominator_rakuten_yamaotoko', ->

  url = 'http://item.rakuten.co.jp/yamaotoko/845035-003/'
  baseInput = "test-robot: dominator rakuten-yamaotoko #{url}"
  size = '27.0'
  ...
  regex = Helper.importDispatcherRegex require '../../../scripts/dominator_rakuten_yamaotoko'
