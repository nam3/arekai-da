...
describe 'dominator_super_sale', ->
  ...
  url = 'http://item.rakuten.co.jp/premoa/4054278191713sss/'
  baseInput = "test-robot: dominator rakuten-premoa #{url}"
  from = '1986-12-02T00:00:00'
  attempts = '16'
  interval = '10'
  concurrency = '1'
  users = 'user001,user002'
  regex = Helper.importDispatcherRegex require '../../../scripts/dominator_rakuten_premoa'
