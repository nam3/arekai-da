...
describe 'dominator_supreme_restock', ->

  baseInput = "test-robot: dominator supreme-restock"
  itemId = '123456'
  category = 'jackets'
  ...
  regex = Helper.importDispatcherRegex require '../../../scripts/dominator_supreme_restock'
