...
module.exports = (robot) ->
  ...
  robot.respond /dominator\s+rakuten-project16\s+(https?:\/\/[\w/:%#$&?()~.=+_-]+)(?:\s*--from=([T\d:-]+)|)(?:\s*--type=([\w]*)|)(?:\s*--payment-method=(transfer|cod|seven-eleven|lawson)|)(?:\s*--attempts=([\d]+)|)(?:\s*--interval=([\d]+)|)(?:\s*--concurrency=([\d]+)|)$/, (res) ->
