# Description
#   Purchase Rakuten with nightmare(browser integration)
#
# Configuration:
#   MONGODB_USER
#   MONGODB_PASSWORD
...
#
# Commands:
#   arekai-da: dominator rakuten "ITEM_LINK" --type=e.g:27.0, BLACK --from=1986-12-02T00:00:00 --attempts=1 --interval=1000 --concurrency=1 --users=user001,user002
#
# Author:
#   JumpeiArashi

Moment = require('moment-timezone')
register = require('dominator').registerRakutenJob
utils = require './utils/hubot'

module.exports = (robot) ->

  robot.respond /dominator\s+rakuten\s+(https?:\/\/[\w/:%#$&?()~.=+_-]+)(?:\s*--type=([\w.]+)|)(?:\s*--from=([T\d:-]+)|)(?:\s*--attempts=([\d]+)|)(?:\s*--interval=([\d]+)|)(?:\s*--concurrency=([\d]+)|)(?:\s*--users=([\w_,]+)|)$/, (res) ->
