...
#
# Commands:
#   arekai-da: dominator rakuten-super-sale "ITEM_LINK" --from=1986-12-02T00:00:00 --type=e.g color,size: rakuten inventory_choice --payment-method=transfer|cod|seven-eleven|lawson  --attempts=1 --interval=1000 --concurrency=1
#
# Author:
#   JumpeiArashi
...
module.exports = (robot) ->
  ...
  robot.respond /dominator\s+rakuten-super-sale\s+(https?:\/\/[\w/:%#$&?()~.=+_-]+)(?:\s*--from=([T\d:-]+)|)(?:\s*--type=([\w]*)|)(?:\s*--payment-method=(transfer|cod|edy)|)(?:\s*--attempts=([\d]+)|)(?:\s*--interval=([\d]+)|)(?:\s*--concurrency=([\d]+)|)$/, (res) ->
