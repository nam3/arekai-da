...
#
# Commands:
#   arekai-da: buy nike presto "TARGET_URL" --size=SIZE(e.g: 27, 27.5) --purchase=true --from=1986-12-02T00:00:00 --interval=2 --times=10 --concurrency=2
#
# Author:
#   JumpeiArashi

Controller = require './controllers/buy_nike_presto'
utils = require './utils/hubot'

module.exports = (robot) ->

  robot.respond /buy\s+nike\s+presto\s+(https?:\/\/[\w/:%#$&?()~.=+_-]+)(?:\s*--size=([\d.]+)|)(?:\s*--purchase=([\w]+)|)(?:\s*--from=([T\d:-]+)|)(?:\s*--interval=([\d]+)|)(?:\s*--times=([\d]+)|)(?:\s*--concurrency=([\d]+)|)$/, (res) ->
