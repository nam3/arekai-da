...
#
# Commands:
#   arekai-da: dominator rakuten-yamaotoko "ITEM_LINK" --size=e.g:27.0, 27.5 --from=1986-12-02T00:00:00 --attempts=1 --interval=1000 --concurrency=1 --users=user001,user002
#
# Author:
#   JumpeiArashi
...
module.exports = (robot) ->
  ...
  robot.respond /dominator\s+rakuten-yamaotoko\s+(https?:\/\/[\w/:%#$&?()~.=+_-]+)(?:\s*--size=([\d.]+)|)(?:\s*--from=([T\d:-]+)|)(?:\s*--attempts=([\d]+)|)(?:\s*--interval=([\d]+)|)(?:\s*--concurrency=([\d]+)|)(?:\s*--users=([\w_,]+)|)$/, (res) ->
