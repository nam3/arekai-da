# Description
#   Purchase Rakuten Mita Sneakers Shoe with dominator
#
# Configuration:
#   MONGODB_USER
#   MONGODB_PASSWORD
...
#
# Commands:
#   arekai-da: dominator rakuten-mita-sneakers "ITEM_LINK" --size=e.g:27.0, 27.5 --from=1986-12-02T00:00:00 --attempts=1 --interval=1000 --concurrency=1
#
# Author:
#   JumpeiArashi
...
module.exports = (robot) ->
  ...
  robot.respond /dominator\s+rakuten-mita-sneakers\s+(https?:\/\/[\w/:%#$&?()~.=+_-]+)(?:\s*--size=([\d.]+)|)(?:\s*--from=([T\d:-]+)|)(?:\s*--attempts=([\d]+)|)(?:\s*--interval=([\d]+)|)(?:\s*--concurrency=([\d]+)|)$/, (res) ->
